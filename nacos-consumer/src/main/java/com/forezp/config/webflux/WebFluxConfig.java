...
public class WebFluxConfig implements WebFluxConfigurer {
    ...
    ReactorResourceFactory resourceFactory() {
        ...
        factory.setConnectionProvider(ConnectionProvider.fixed("reactor-consumer-queue", 100, 10000));
        factory.setLoopResources(LoopResources.create("reactor-consumer-work", 10, true));
        return factory;
    }
}
